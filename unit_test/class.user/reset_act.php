...
$user = new user($arr);
echo "Test reset_act_1 : " . unit_test($user->reset_act(), $user->get_err_code('ERR_MAIL_FIELD_EMPTY')) . "<br/>";
unset($user);
...
$user = new user($arr);
echo "Test reset_act_2 : " . unit_test($user->reset_act(), $user->get_err_code('ERR_MAIL_NOT_FOUND')) . "<br/>";
unset($user);
...
$user = new user($arr);
echo "Test reset_act_3 : " . unit_test($user->reset_act(), 0) . "<br/>";
unset($user);
